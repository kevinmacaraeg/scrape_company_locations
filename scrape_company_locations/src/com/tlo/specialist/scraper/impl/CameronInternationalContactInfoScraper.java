...
public class CameronInternationalContactInfoScraper implements CompanyContactInfoScraper {

	private static Logger logger = Logger.getLogger(CameronInternationalContactInfoScraper.class.getName());
	
	private static final String CAMERON_LOCATIONS_URL = "http://cameron.slb.com/contact-us/locations";
	
	private static final String CAMERON_NEXT_BUTTON_TEXT = "Next";
	
	private static final String CAMERON_OFFICE_LOCATIONS_CSS_SELECTOR = "div.location-text";

	@Override
	public void scrapeCompanyContactInformation(String masterCompanyId, String masterCompanyName, String outputFilePath) throws Exception {
		try {
			
			logger.info("Connecting to " + CAMERON_LOCATIONS_URL +"......");
			WebDriver driver = new ChromeDriver();
			driver.get(CAMERON_LOCATIONS_URL);
			Thread.sleep(3000);
			...
			do {
				...
				try {
					nextPageButtonElement = driver.findElement(By.linkText(CAMERON_NEXT_BUTTON_TEXT));
				...
				Elements officeLocationsElements = websiteDocument.select(CAMERON_OFFICE_LOCATIONS_CSS_SELECTOR);
